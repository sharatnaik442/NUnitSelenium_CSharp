...
namespace NUnitSeleniumTraining.Selenium
{
    internal class Booking
    {
        ...
        public void SearchFunctionality()
        {
            ...
            checkin.Click();
            IWebElement flexible = driver.FindElement(By.Id("flexible-searchboxdatepicker-tab-trigger"));
            flexible.Click();
            ...
            guest.Click();
            driver.FindElement(By.XPath("//body[1]/div[3]/div[2]/div[1]/form[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[2]/div[2]/button[2]")).Click();
            IWebElement Dropdown = driver.FindElement(By.Name("age"));
            ...
            //IWebElement done = driver.FindElement(By.XPath("(//span[normalize-space()='Done'])[1]"));
            //done.Click();
